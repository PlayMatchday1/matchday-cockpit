...
async function main() {
  ...
  /* THE RAIL IS THE SECTION'S CONTENTS, AND IT HAS GROWN THREE TIMES. This pinned
   * ["Field Pipeline"] alone; VC Outreach joined it (0166), then 2026 Daily Matches, and now Field
   * Launches sits second in the Fields group. The list stays EXACT rather than becoming a
   * "contains" — the ORDER and the hrefs are what this asserts, and a new page appearing in the
   * wrong group would slip straight past a contains. */
  eq("…with the section's four pages in it", shell.items,
    ["Field Pipeline", "Field Launches", "2026 Daily Matches", "VC Outreach"]);
  eq("…each pointing at its own route", shell.hrefs,
    ["/growth/field-pipeline", "/growth/launch", "/growth/daily-matches", "/growth/vc-outreach"]);
