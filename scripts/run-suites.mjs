...
const NODE_SUITES = [
  ...
  "scripts/crm-push-test.ts", "scripts/city-manager-test.ts", "scripts/city-scope-test.ts", "scripts/reviews-scope-test.ts", "scripts/promo-uses-model-test.ts", "scripts/sync-logging-test.ts", "scripts/verify-checkin-model.ts", "scripts/roster-edit-model-test.ts", "scripts/credits-model-test.ts", "scripts/partner-payout-model-test.ts",
];
