// POST /api/sync/promocodes — manual trigger for the mdapi_promocodes
// sync. Backs the SyncCard "Sync now" button on /data → Promocodes
// section.
//
...
//           authenticated INSERT/UPDATE on mdapi_promocodes (migration
//           0017).
//   Cron:   Bearer ${CRON_SECRET}. Service-role client. Cron path
//           isn't used today (orchestrator hits /api/sync/cron) but
//           kept for parity.
...
// ~6k rows in ~2s typical. 60s is plenty.
