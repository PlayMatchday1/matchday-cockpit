...
//
// MEMBERSHIP KEEPS ITS URL. /membership is not under /growth and is not being moved there —
...
//
// LABELS ONLY. The route segment, this file, this export and every component name still say
// "growth"; nothing a person reads does.
//
...
export const GROWTH_SECTIONS: RailItem[] = [
  {
    key: "growth-funnel", group: "Reports", label: "Player Funnel", href: "/growth/funnel",
    desc: "Download to registration to a fifth match",
    icon: <I><path d="M3 4.5h18l-7 8.5v6.5l-4 2v-8.5z" /></I>,
  },
  {
    key: "growth-behavior", group: "Reports", label: "Player Behavior", href: "/growth/behavior",
  ...
  {
    key: "growth-arpp", group: "Reports", label: "Revenue per Player", href: "/growth/revenue-per-player",
  ...
  {
    key: "growth-retention", group: "Reports", label: "Retention", href: "/growth/retention",
  ...
  {
    key: "growth-churn", group: "Reports", label: "Churn", href: "/growth/churn",
  ...
  {
    key: "growth-dataroom", group: "Reports", label: "Player Data Room", href: "/growth/data-room",
...
// gated on `growth`, Membership on `membership`. A user with one permission and not the other sees
// only their half rather than links that bounce off a guard.
export const SECTION_PAGE: Record<string, "growth" | "membership"> = {
