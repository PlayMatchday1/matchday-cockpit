...
// offset, in ONE place.
//
// WHY IT IS EXTRACTED. This rail now mounts on two routes that are not nested: /lifecycle/* under
// LifecycleShell, and /membership under MembershipShell. Those two must render the SAME rail — same
...
// two shells do NOT share. /lifecycle guards on `lifecycle` and mounts GrowthDataProvider; /membership
...
// SHARED WITH /lifecycle ON PURPOSE. Collapsing the rail on a report and clicking through to
