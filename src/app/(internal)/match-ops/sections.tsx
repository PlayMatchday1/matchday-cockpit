...
export const MATCH_OPS_SECTIONS: MatchOpsSection[] = [
  ...
  { key: "slate-review", group: "Operations", label: "Slate Review", href: "/match-ops/slate-review", desc: "Weekly per-city decision snapshot", access: "cities", icon: <I><path d="M4 5h16v14H4z" /><path d="M8 9h8M8 13h8M8 17h5" /></I> },
